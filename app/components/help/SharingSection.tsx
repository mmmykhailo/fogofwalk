...
export function SharingSection() {
  return (
    <PageSection title="Sharing an activity">
      <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
        <p>
          Select a track and open the share button to build a portrait image
          sized for a story or a post. You choose:
        </p>
        <ul className="ml-4 list-disc space-y-1">
          <li>
            <strong className="text-foreground">Background</strong> —{" "}
            <em>Map</em> renders a snapshot of the route, <em>Photo</em> uses
            one of the photos matched to that activity (with arrows to pick
            which), and <em>Dark</em> is a plain backdrop
          </li>
          <li>
        ...
        <p>
          If you have a lap selected, the card is built from that lap alone —
          its distance, its time, and only the photos taken during it.
        </p>
      </div>
    </PageSection>
  )
