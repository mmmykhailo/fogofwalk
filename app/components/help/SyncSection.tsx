  ...
  return (
    <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
      <p>
        ...
        on its own it never sends your data anywhere — the fog, your tracks and
        your photos are computed and stored on the device you are using.
      </p>
      <p>
      ...
      <ul className="ml-4 list-disc space-y-1">
        ...
        <li>
          Signing in does not automatically grant sync. On a server whose owner
          keeps an invite list you may be signed in but{" "}
