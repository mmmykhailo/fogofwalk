  ...
  return (
    <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
      <p>
        ...
        the photo's timestamp to the nearest point in your activities. Photos
        are only offered once you have at least one activity loaded.
      </p>
      <p>
      ...
      <ul className="ml-4 list-disc space-y-1">
        ...
        <li>Activities must be loaded first</li>
        <li>
          The photo must be taken within 5 minutes of a recorded activity point
        </li>
        <li>
          The activity itself must carry{" "}
      ...
      <p>
        ...
        clusters are recalculated as you zoom, so zooming in splits them apart.
        Tap a marker or cluster to open the photo viewer, which you can drag
        around the screen.
      </p>
      <Alert>
        <AlertTitle>Photos not showing up?</AlertTitle>
        <AlertDescription>
          The most common reasons: no activities loaded yet, the photo has no
          timestamp (a screenshot or an edited copy), the photo was taken more
          than 5 minutes before or after any tracked activity, or the activity
          it belongs to is a planned route with no per-point times.
        </AlertDescription>
      </Alert>
    </div>
  )
