    ...
    <PageSection title="Statistics">
      <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
        ...
        <ul className="ml-4 list-disc space-y-1">
          ...
          <li>
            <strong className="text-foreground">Unique distance</strong> — how
            far you've travelled counting each stretch of ground only once, no
            matter how many times you've run it. Your total distance grows every
            time you repeat a loop; this only grows when you go somewhere new
          </li>
          <li>
            A weekly bar chart of distance, from your first activity to now
          </li>
          <li>
