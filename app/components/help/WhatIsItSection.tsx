    ...
    <PageSection title="What is Fog of Walk?">
      <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
        ...
        <p>
          ...
          own movement. After importing your activities you'll quickly spot the
          neighbourhoods you know well, the streets you've never set foot on,
          and the blank patches just waiting to be discovered.
        </p>
        <p>
